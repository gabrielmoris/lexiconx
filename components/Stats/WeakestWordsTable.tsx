  ...
  if (!data || data.length === 0) {
    return (
      <div className="border border-theme-bg-light dark:border-theme-bg-dark rounded-lg p-6">
        ...
        <p className="text-theme-fg-light dark:text-theme-fg-dark text-sm">{t('no-data-yet')}</p>
      </div>
    );
  }
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-theme-bg-light dark:border-theme-bg-dark">
              <th className="text-left py-2 px-3 text-theme-fg-light dark:text-theme-fg-dark">
                {t('word')}
              </th>
              <th className="text-left py-2 px-3 text-theme-fg-light dark:text-theme-fg-dark">
                {t('definition')}
              </th>
              <th className="text-center py-2 px-3 text-theme-fg-light dark:text-theme-fg-dark">
                {t('ease-factor')}
              </th>
              <th className="text-right py-2 px-3 text-theme-fg-light dark:text-theme-fg-dark">
                {t('last-reviewed')}
              </th>
            </tr>
          </thead>
