...
- 185 files · ~68,758 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 664 nodes · 1342 edges · 39 communities (25 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness

- Built from commit: `e2abf507`
...
Cohesion: 0.05
Nodes (67): AuthProvider(), AuthProviderProps, DeckBuilder(), DeckBuilderProps, DeckCard(), DecksManager(), View, DeleteAccountIcon() (+59 more)
...
Cohesion: 0.06
Nodes (36): MemoryHookCardProps, AIClient, AIGenerateContentParams, AIProvider, createAIClient(), FallbackAIClient, createGoogleClient(), createNvidiaClient() (+28 more)

### Community 3 - "Community 3"

Cohesion: 0.07
Nodes (35): ChinaFlag(), ChinaFlagProps, EnglishFlagProps, GermanFlag(), GermanFlagProps, RussianFlag(), RussianFlagProps, SpanishFlag() (+27 more)

### Community 4 - "Community 4"

Cohesion: 0.08
Nodes (38): generateWords(), authOptions, JWT, Session, User, getWordCategory(), deckSchema, quizSessionSchema (+30 more)
...
Cohesion: 0.08
Nodes (27): DeckReview(), ArrowLeft(), ArrowLeftProps, ArrowRight(), ArrowRightProps, RemoveIcon(), RemoveIconProps, SoundIcon() (+19 more)

### Community 8 - "Community 8"

Cohesion: 0.07
Nodes (23): DeckCardProps, AnonIcon(), AnonIconProps, CardsIcon(), CardsIconProps, DeckIconProps, EditIcon(), EditIconProps (+15 more)
...
Cohesion: 0.14
Nodes (13): AiGenerateVocabulary(), LexiconxLogo(), LexiconxLogoProps, WordAiIcon(), WordAiIconProps, Header(), useGenerateWords(), getUserData() (+5 more)
...
Cohesion: 0.50
Nodes (3): **dirname, **filename, server

## Knowledge Gaps

- **261 isolated node(s):** `session-start.sh script`, `husky.sh script`, `AuthProviderProps`, `View`, `AnonIconProps` (+256 more)
...
- **Why does `Language` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 7`, `Community 13`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `Word` connect `Community 2` to `Community 0`, `Community 1`, `Community 4`, `Community 7`?**
