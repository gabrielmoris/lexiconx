...
const _apiHandler = async (
	...
	const config: RequestInit = {
		method,
		headers,
		credentials: "include", // Include cookies for client-side session validation
	};
...
export const wordsGeneration = async (languageToLearn: Language, userLanguage: Language, level: number, isSSR = false, ssrHeaders?: Record<string, string>) => {
...
// QUIZ RELATED APIS
export const quizGeneration = async (languageToLearn: Language, userLanguage: Language, level: number, isSSR = false, ssrHeaders?: Record<string, string>) => {
