...
const StatsPage = () => {
  ...
  if (loading || !statsData) {
    return (
      <main className="flex items-center justify-center py-20 px-4 md:w-xl md:p-20 min-h-[calc(100vh-5rem)]">
  ...
  return (
    <main className="flex items-center justify-center py-10 px-2 md:p-10 w-screen">
      <div className="w-full max-w-3xl space-y-6">
        <h1 className="text-3xl font-extrabold text-center pb-4 text-theme-text-light dark:text-theme-text-dark">
          {t('title')}
        </h1>
